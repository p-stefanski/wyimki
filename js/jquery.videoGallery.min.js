...
f.extend({},f.fn.videoGallery.defaults,e);this.useRollovers=(this.isMobile=MGCUtils.isMobile())?!1:!0;this.isIE=MGCUtils.isMobile();this.ic_volume="media/data/video_icons/volume.png";this.ic_volume_on="media/data/video_icons/volume_on.png";this.ic_mute="media/data/video_icons/mute.png";this.ic_mute_on="media/data/video_icons/mute_on.png";this.ic_pause="media/data/video_icons/pause.png";this.ic_pause_on="media/data/video_icons/pause_on.png";this.ic_play="media/data/video_icons/play.png";this.ic_play_on=
"media/data/video_icons/play_on.png";this.ic_fullscreen_enter="media/data/video_icons/fullscreen_enter.png";this.ic_fullscreen_enter_on="media/data/video_icons/fullscreen_enter_on.png";this.ic_fullscreen_exit="media/data/video_icons/fullscreen_exit.png";this.ic_fullscreen_exit_on="media/data/video_icons/fullscreen_exit_on.png";this.ic_player_prev="media/data/video_icons/v_prev.png";this.ic_player_prev_on="media/data/video_icons/v_prev_on.png";this.ic_player_next="media/data/video_icons/v_next.png";
this.ic_player_next_on="media/data/video_icons/v_next_on.png";this.ic_w_play="media/data/video_icons/w_play.png";this.ic_w_pause="media/data/video_icons/w_pause.png";this.ic_close="media/data/video_icons/close.png";this.ic_close_on="media/data/video_icons/close_on.png";this._componentInited=!1;this._body=f("body");this.bodyOverflowOrig=this._body.css("overflow");this._window=f(window);this._doc=f(document);this._windowResizeInterval=200;this._windowResizeIntervalID;this._mediaPath;this._mediaType;
