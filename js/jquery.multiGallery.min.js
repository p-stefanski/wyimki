...
"right"==W&&(side="left",a=ja?l("w")+"px":l("w")-r.width()+"px",r.stop().animate({left:a},{duration:500,easing:"easeOutQuint"}));ja?(lb.children("img").attr("src","media/data/gallery_icons/plus.png"),ja=!1):(lb.children("img").attr("src","media/data/gallery_icons/minus.png"),ja=!0)}}function sc(){za&&("top"==W?"inside"==qa?ja?r.css("top","0px"):r.css("top",-r.height()+"px"):(r.css("top","0px"),J.css("top",r.height()+"px")):"bottom"==W?"inside"==qa&&(ja?r.css("top",l("h")-r.height()+"px"):r.css("top",
...
2-b/2+"px",top:l("h")/2-c/2+"px"},{duration:A,easing:z,complete:function(){L()}});ta=!0}else sb(),Eb()}function L(a){F||(a&&a.empty().css("display","none"),E=!1,Qd(),Xb=!1,O&&!ha&&(I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/pause.png"),zc(),Zb()))}function Ee(){Sa=E=!0;var a=eb[u].main;if(a[v()]){var b=a[v()],c=l("w"),d=l("h"),e=b[0].origWidth,f=b[0].origHeight;a=g(Y[v()]);var k=!1,h=parseFloat(a.attr("data-startScale"));if(isNaN(h)||0==h)h=1;var n=parseFloat(a.attr("data-endScale"));
...
I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/pause.png");zc();a.stop().animate({opacity:1},{duration:ed,easing:"easeOutSine",queue:!1,complete:function(){rb(g(this)).stop().empty().css("display","none");Xc||Qd();Xc=!0;Xb=Sa=!1;!O&&E?Ac():fd&&Ac()}});Hb=a;O?(Zb(),a.animate({left:Ta+"px",top:t+"px",width:c+"px",height:d+"px"},{duration:Ka+ed,easing:"linear",queue:!1,complete:function(){}})):E=!1;Yc=!0}else sb(),Eb()}function Ac(){if(!w||F||Sa)return!1;Hb.stop();Z();E=!1}
...
function Rd(a){var b=!1;""==a.replace(/\s/g,"")&&(b=!0);return b}function $c(a){var b=a.splice(Math.floor(Math.random()*(a.length-1)),1)[0];a.push(b);return b}function dd(a){return a[Math.round(Math.random()*(a.length-1))]}function Sd(a,b){var c=0,d=b.length;for(c;c<d;c++){var e=b[c];if(a==e){var f=!0;break}}return f}function Ud(a){ha&&(O||(O=!0),ha=!1);O?(Z(),O=!1,ca?I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/play.png"):I.children("img")&&I.children("img").attr("src",
a?"media/data/gallery_icons/play_on.png":"media/data/gallery_icons/play.png"),"KEN_BURNS"==B&&E&&Ac()):(O=!0,ca?I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/pause.png"):I.children("img")&&I.children("img").attr("src",a?"media/data/gallery_icons/pause_on.png":"media/data/gallery_icons/pause.png"),Ka||zc(),"KEN_BURNS"!=B?E||Zb():E||Td())}function Pb(a){a?(O=!0,I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/pause.png"),Ka||zc(),"KEN_BURNS"!=B?E||
Zb():E||Td()):(Z(),O=!1,I.children("img")&&I.children("img").attr("src","media/data/gallery_icons/play.png"),"KEN_BURNS"==B&&E&&Ac())}function Z(){ac&&clearTimeout(ac);fb.length&&fb.stop();Ka&&(Vd=(new Date).getTime()-Wd,Ka-=Vd)}function Zb(){ac&&clearTimeout(ac);Wd=(new Date).getTime();ac=setTimeout(gd,Ka);if(fb.length){var a=l("w");fb.stop().animate({width:a+"px"},{duration:Ka,easing:"linear"})}}function zc(){if(Qe)var a=void 0!=ma.attr("data-duration")?parseFloat(ma.attr("data-duration"),10):0<
...
{duration:500,easing:"easeOutSine",complete:function(){bc.css("display","none")}})}function Mc(a){return 0==a.replace(/^\s+|\s+$/g,"").length}function va(a){w&&(a||(a=window.event),a.cancelBubble?a.cancelBubble=!0:a.stopPropagation&&a.stopPropagation(),a=g(a.currentTarget).attr("class"),"music_toggle"==a?cc.children("img").attr("src","media/data/audio_icons/music_on.png"):"controls_prev"==a?hd.children("img").attr("src","media/data/gallery_icons/prev_on.png"):"controls_toggle"==a?O?I.children("img").attr("src",
"media/data/gallery_icons/pause_on.png"):I.children("img").attr("src","media/data/gallery_icons/play_on.png"):"controls_next"==a?id.children("img").attr("src","media/data/gallery_icons/next_on.png"):"info_toggle"==a?tb.children("img").attr("src","media/data/gallery_icons/info_on.png"):"link_toggle"==a?Ib.children("img").attr("src","media/data/gallery_icons/link_on.png"):"playlist_toggle"==a?ja?lb.children("img").attr("src","media/data/gallery_icons/minus_on.png"):lb.children("img").attr("src","media/data/gallery_icons/plus_on.png"):
"gallery_fullscreen"==a?"normal"==Cc?Va.children("img").attr("src","media/data/gallery_icons/fullscreen_enter_on.png"):Va.children("img").attr("src","media/data/gallery_icons/fullscreen_exit_on.png"):"share_toggle"==a?jd.children("img").attr("src","media/data/gallery_icons/share_toggle_on.png"):"facebook_toggle"==a?kd.children("img").attr("src","media/data/gallery_icons/facebook_on.png"):"twitter_toggle"==a?ld.children("img").attr("src","media/data/gallery_icons/twitter_on.png"):"tumblr_toggle"==
a&&md.children("img").attr("src","media/data/gallery_icons/tumblr_on.png"))}function wa(a){w&&(a||(a=window.event),a.cancelBubble?a.cancelBubble=!0:a.stopPropagation&&a.stopPropagation(),a=g(a.currentTarget).attr("class"),"music_toggle"==a?cc.children("img").attr("src","media/data/audio_icons/music.png"):"controls_prev"==a?hd.children("img").attr("src","media/data/gallery_icons/prev.png"):"controls_toggle"==a?O?I.children("img").attr("src","media/data/gallery_icons/pause.png"):I.children("img").attr("src",
"media/data/gallery_icons/play.png"):"controls_next"==a?id.children("img").attr("src","media/data/gallery_icons/next.png"):"info_toggle"==a?tb.children("img").attr("src","media/data/gallery_icons/info.png"):"link_toggle"==a?Ib.children("img").attr("src","media/data/gallery_icons/link.png"):"playlist_toggle"==a?ja?lb.children("img").attr("src","media/data/gallery_icons/minus.png"):lb.children("img").attr("src","media/data/gallery_icons/plus.png"):"gallery_fullscreen"==a?"normal"==Cc?Va.children("img").attr("src",
"media/data/gallery_icons/fullscreen_enter.png"):Va.children("img").attr("src","media/data/gallery_icons/fullscreen_exit.png"):"share_toggle"==a?jd.children("img").attr("src","media/data/gallery_icons/share_toggle.png"):"facebook_toggle"==a?kd.children("img").attr("src","media/data/gallery_icons/facebook.png"):"twitter_toggle"==a?ld.children("img").attr("src","media/data/gallery_icons/twitter.png"):"tumblr_toggle"==a&&md.children("img").attr("src","media/data/gallery_icons/tumblr.png"))}function Ca(a){if(!w)return!1;
...
b.endX+"px",c[b.pos_y]=b.endY+"px",c.opacity=1,c),{duration:b.time,easing:b.ease})}Fc&&void 0!=a.attr("data-description")&&!Mc(a.attr("data-description"))&&(Zd=a.attr("data-description"),La.css("width","auto").html(Zd),parseInt(La.css("width"),10)>$d&&La.css("width",$d+"px"),Fc&&(tb.children("img").attr("src","media/data/gallery_icons/info.png"),tb.css({opacity:0,display:"block"}).stop().animate({opacity:1},{duration:400,easing:"easeOutSine"})),Se&&pd());vb&&(void 0!=a.attr("data-vimeo")?(gc="vimeo",
...
if(qd)he.on("fullscreenchange mozfullscreenchange webkitfullscreenchange",function(){document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen?(Cc="normal",Va.find("img").attr("src","media/data/gallery_icons/fullscreen_enter.png")):(Cc="fullscreen",Va.find("img").attr("src","media/data/gallery_icons/fullscreen_exit.png"))});var kd=p.find(".facebook_toggle").css("cursor","pointer").on("click",Ca);if(!ca)kd.on("mouseover",va).on("mouseout",
